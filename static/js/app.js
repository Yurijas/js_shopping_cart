// // create global cart variable
// // TODO: change out variable for session storage later
// var cart = [];
// // example of getting setting sessionStorage information
// let item = {
//   'id': 101,
//   'name': 'Title',
//   'price': 3.98
// };
// // put string info to sessionStorage key, value
// // js to json (make it string)
// sessionStorage.setItem('item', JSON.stringfy(item));
// // to get information
// // console.log(sessionStorage.getItem('item'));
// // turn it to js (retrieving information and turning it back to an object)
